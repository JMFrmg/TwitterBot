...
Enfin, la quatrième fonction de ce bot est de collecter les ids de tous les nouveaux tweets apparaissant dans le fil d'actualité de l'utilisateur connecté et de les liker. C'est la fonction numéro 4. Fais attention, si tu la lance, ça risque de prendre du temps avant que les n(tu peux modifier ce nombre) nouveaux tweets apparaissent. Il est intéressant d'utiliser cette dernière fonction après la première afin d'avoir un maximum d'amis sur tweeter et donc un maximum de tweets dans un domaine donné qui apparaissent dans le fil d'actualité.

Bonne lecture et bon courage pour la suite de la formation :)
